...
class GrammerColors {
  ...
  const GrammerColors({required this.isDarkMode});

  Color get pageBgColor =>
      isDarkMode ? const Color(0xFF121212) : const Color(0xFFF7F7F7);
  Color get createContainerBgColor1 =>
      isDarkMode ? const Color(0xFF333333) : const Color(0xFFCE97FD);
  Color get createContainerBgColor2 =>
      isDarkMode ? const Color(0xFF333333) : const Color(0xFFD099FF);
  Color get createContainerBgColor3 =>
      isDarkMode ? const Color(0xFF333333) : const Color(0xFFCC90FF);
