...
class SpeakingColors {
  final bool isDarkMode;

  const SpeakingColors({required this.isDarkMode});

  Color get pageBgColor =>
      isDarkMode ? const Color(0xFF121212) : const Color(0xFFF7F7F7);
  Color get createContainerBgColor1 =>
      isDarkMode ? const Color(0xFF333333) : const Color(0xFFFFAF7E);
  Color get createContainerBgColor2 =>
      isDarkMode ? const Color(0xFF333333) : const Color(0xFFFFAA78);
  Color get createContainerBgColor3 =>
      isDarkMode ? const Color(0xFF333333) : const Color(0xFFFFA26B);
